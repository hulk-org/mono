...
description: wrkstrm app backed by Beads — the task management UI for molecules, gates, and Koma execution; name is "Workflow"
type: project
---
...
Dolt persistence). Koma provides execution. Ghost bridges them. Workflow is
the operator-facing app that ties it all together — display molecules, approve
gates, pin work to agents, watch Koma pipelines execute.
