...
Koma system organized into six semantic domains:
...
**The rule:** higher domains can depend on lower, never reverse. The Ghost is the only entity that spans all domains. On-disk: `koma-org/mono/domain/<domain>/<komo>/`.
