...
2. **Concurrent commit awareness**: detect `index.lock` presence per repo, show which repos have active git operations. This session hit a lock conflict when koma-git and another agent committed simultaneously.
