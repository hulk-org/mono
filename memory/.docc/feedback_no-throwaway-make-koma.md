---
name: No throwaway code — make a Koma
...
2. If yes: invoke it (`koma-<slug> --payload ... [--prompt ...]`)
3. If no: create the Komo (spec, lineage, katakana files, Tool + CLI, tests)
4. The Komo lives forever in koma-org. Next time anyone needs this operation, it's there.
