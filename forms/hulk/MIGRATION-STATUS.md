...
- ✅ **2026-06-03 config-home repair** — `/Users/sonoma/.claude` was repaired
  from a broken link targeting `mono/private/universal/substrate/harnesses/hulk`
  to the live Claude runtime home at
  `mono/private/universal/substrate/agents/claude/forms/hulk`.
- ✅ **2026-06-03 inner projection repair** — the form-home projections
  `projects`, `sessions`, `archived_sessions`, `skills`, and `agents/claude`
  were repaired and verified to resolve.
- ✅ **2026-06-03 module-store worktree repair** — the historical git module
  store at `.git/modules/private/universal/substrate/harnesses/hulk/config`
  now points its `core.worktree` at
  `private/universal/substrate/agents/claude`.
- ✅ **2026-06-03 workflow capture** — reusable repair doctrine now lives at
  `kura-spaces/workflows/harness-config-home-integrity-repair/v0.1.0/`.

Historical sections below still describe the 2026-04-06 migration moment.
Treat the live runtime target above as the current truth.
