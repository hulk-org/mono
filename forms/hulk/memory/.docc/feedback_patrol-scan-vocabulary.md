...
- **Action** — the schema-field name (per `digikoma-org` `spec.json` and `DigikomaAction` in core-entity-set v0.9.0 organism-schemas v0.4.0). Catalog values: fetch, clean, mark, trace, validate, index, watch.
